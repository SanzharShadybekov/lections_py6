# Декоратор - это функция, которая позволяет без изменения кода фукнции расширить функционал той функции к котрой был применен декоратор.
...
#         print(f'Time to get result: {round(finish - start, 1)} sec')
#     return wrapper
